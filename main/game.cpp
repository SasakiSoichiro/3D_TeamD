...
void InitGame(void)
{
	...
	//	ビルボード(×)
	SetBillboard(D3DXVECTOR3(-1775.0f, 50.0f, -300.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), BILLBOARDTYPE_2, D3DXVECTOR3(4.0f, 4.0f, 0.0f));

	//	ビルボード(〇)
	SetBillboard(D3DXVECTOR3(-1775.0f, 25.0f, -300.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), BILLBOARDTYPE_3, D3DXVECTOR3(4.0f, 4.0f, 0.0f));
