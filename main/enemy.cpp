...
void LoiterEnemy(void)
{
	...
	Turn[0] = D3DXVECTOR3(500.0f, 0.0f, 300.0f);
	Turn[1] = D3DXVECTOR3(500.0f, 0.0f, -500.0f);
	Turn[2] = D3DXVECTOR3(-500.0f, 0.0f, -400.0f);
	Turn[3] = D3DXVECTOR3(-500.0f, 0.0f, 500.0f);
	Turn[4] = D3DXVECTOR3(-600.0f, 0.0f, 500.0f);
	Turn[5] = D3DXVECTOR3(500.0f, 0.0f, 600.0f);
	Turn[6] = D3DXVECTOR3(-500.0f, 0.0f, -400.0f);
	Turn[7] = D3DXVECTOR3(-600.0f, 0.0f, 500.0f);
